...
import { Leaf, Coffee, UtensilsCrossed, Gift, ShoppingBag, Flame, Sparkles } from "lucide-react";
...
const products = [
  ...
  {
    name: "Woven Baskets",
    description: "Colorful handwoven mesob baskets with intricate Ethiopian patterns",
    image: baskets,
    category: "Crafts",
    icon: Sparkles,
    color: "text-primary",
  ...
  {
    name: "Grocery & Snacks",
    description: "Specialty drinks, chips, candy, household items, and everyday essentials",
    image: storeInterior,
    category: "Grocery",
    icon: ShoppingBag,
    color: "text-ethiopian-red",
              ...
              <div className="max-w-2xl">
                ...
                <div className="flex items-center gap-2 md:gap-4 text-[10px] md:text-sm">
                  {["Fresh", "Authentic", "Traditional"].map((tag, i) => (
                    <motion.span 
                      key={tag}
                      className={`uppercase tracking-wider ${i === 0 ? 'text-ethiopian-green' : i === 1 ? 'text-primary' : 'text-ethiopian-red'}`}
            ...
            >
              <div className="relative aspect-[3/4] md:aspect-[4/5] overflow-hidden bg-card rounded-sm">
                ...
                >
                  ...
                  <span className={`text-[10px] uppercase tracking-[0.2em] ${product.color} bg-background/90 px-2 py-1 backdrop-blur-sm rounded-sm`}>
                    {product.category}
                  </span>
                </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <span className="text-ethiopian-green text-xs uppercase tracking-widest">Coffee Ceremony</span>
              <h4 className="font-serif text-xl md:text-2xl text-foreground mt-1">Fresh Roasted Daily</h4>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center p-4 md:p-8 bg-card/50 rounded-sm border border-border/30">
            ...
            >
              ...
              <span className="text-primary uppercase tracking-widest text-xs">Coffee Counter</span>
            </motion.div>
            ...
            <p className="text-muted-foreground font-light text-sm md:text-base mb-6">
              Visit our coffee counter for freshly brewed Ethiopian coffee, prepared in the traditional way. 
              We also offer jebena pots, coffee sets, and the finest beans to take home.
            </p>
