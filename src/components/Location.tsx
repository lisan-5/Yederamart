      ...
      <div ref={containerRef} className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-start">
          ...
          >
            ...
            <div className="relative aspect-square lg:aspect-[4/3] mb-6 md:mb-8 group">
              {/* Tricolor frame */}
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
                <div className="relative">
                  ...
                  />
                  <div className="w-4 h-4 bg-ethiopian-green rounded-full relative z-10 shadow-lg shadow-ethiopian-green/50" />
                </div>
              </div>
            </div>

            {/* Address Card with cultural styling */}
            <div className="relative bg-background/80 backdrop-blur-sm border border-border p-6 md:p-8 overflow-hidden">
              {/* Corner accents */}
              ...
              <div className="flex items-start gap-3 md:gap-4">
                <div className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-ethiopian-green/20 to-primary/20 flex items-center justify-center shrink-0">
          ...
          >
            ...
            <div className="relative bg-background/80 backdrop-blur-sm border border-border p-6 md:p-8 mb-6 md:mb-8 overflow-hidden">
              {/* Tricolor accent */}
              ...
              <div className="flex items-start gap-3 md:gap-4 mb-6 md:mb-8">
                <div className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-primary/20 to-ethiopian-red/20 flex items-center justify-center shrink-0">
                ...
                {hours.map((item, index) => (
                  ...
                  >
                    <span className="font-light tracking-wide flex items-center gap-2">
                      ...
                      {item.day === currentDay && (
                        <span className="text-[10px] md:text-xs uppercase tracking-widest text-ethiopian-green">(Open)</span>
                      )}
                    </span>
            ...
            >
              <div className="bg-gradient-to-br from-ethiopian-green/10 via-background to-ethiopian-red/10 border border-primary/20 p-6 md:p-10 text-center relative">
                ...
                <div className="absolute top-3 md:top-4 left-3 md:left-4 w-6 md:w-10 h-6 md:h-10">
                ...
                <div className="absolute top-3 md:top-4 right-3 md:right-4 w-6 md:w-10 h-6 md:h-10">
                  <div className="absolute w-full h-0.5 bg-primary top-0 right-0" />
                  <div className="absolute h-full w-0.5 bg-primary top-0 right-0" />
                </div>
                <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 w-6 md:w-10 h-6 md:h-10">
                ...
                <div className="absolute bottom-3 md:bottom-4 right-3 md:right-4 w-6 md:w-10 h-6 md:h-10">
                ...
                <div className="mt-4 md:mt-6 flex items-center justify-center gap-2 text-muted-foreground text-xs md:text-sm">
