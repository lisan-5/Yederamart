...
const Location = () => {
  ...
  return (
    <section
      id="location"
      className="relative py-16 md:py-32 bg-card overflow-hidden"
    >
      ...
      {/* Animated Ethiopian Textile Pattern Background (from About) */}
      ...
      >
        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          >
            Experience the warmth of Ethiopian hospitality at our Stone Mountain
            location
          </motion.p>
        </div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <circle
                          ...
                          cy="12"
                          r="1.5"
                          fill="hsl(var(--ethiopian-green))"
                        />
                        <circle
                          cx="20"
                          cy="24"
                          r="1.5"
                          fill="hsl(var(--ethiopian-red))"
                        />
                        <circle
                          cx="14"
                          cy="18"
                        ...
                        <defs>
                          ...
                          >
                            <stop
                              offset="0%"
                              stopColor="hsl(var(--ethiopian-green))"
                            />
                            <stop
                              offset="50%"
                            ...
                            <stop
                              offset="100%"
                              stopColor="hsl(var(--ethiopian-red))"
                            />
                          </linearGradient>
                          <linearGradient
                            id="crossGradient"
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground font-light leading-relaxed text-sm md:text-base">
                    ...
                    <br />
                    <span className="text-ethiopian-green">
                ...
                {hours.map((item, index) => (
                  ...
                  >
                    <span className="font-light tracking-wide flex items-center gap-2">
                      ...
                      {item.day === currentDay && (
                        <span className="text-[10px] md:text-xs uppercase tracking-widest text-ethiopian-green">
                          (Today)
                        </span>
                      )}
                    </span>
                    <span
                      className={`font-light text-xs md:text-base ${
                        item.closed ? "italic" : ""
                      }`}
                    >
                      {item.hours}
