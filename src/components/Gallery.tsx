...
const images = [
  {
    src: heroBg,
    alt: "Yedera Mart store interior with Ethiopian products",
    span: "col-span-2 row-span-2",
  },
  { src: productSpices, alt: "Colorful Ethiopian spices display" },
  { src: coffeeCounterImage, alt: "Traditional Ethiopian coffee jebena" },
  { src: storeInterior, alt: "Store aisles with snacks and drinks" },
  { src: coffeeCounterImage, alt: "Traditional coffee roasting ceremony" },
  { src: baskets, alt: "Colorful Ethiopian woven baskets" },
  { src: sambusaImage, alt: "Fresh sambusa pastries" },
  { src: injeraImage, alt: "Fresh injera flatbread" },
            ...
            >
              ...
              <motion.div
                className={`absolute top-0 left-0 right-0 h-1 z-20 ${
                  index === 0
                    ? "bg-gradient-to-r from-ethiopian-green via-primary to-ethiopian-red"
                    : index % 3 === 0
                    ? "bg-ethiopian-green"
                    : index % 3 === 1
                    ? "bg-primary"
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <p className="text-foreground text-xs md:text-sm font-light line-clamp-1">
                  {image.alt}
                </p>
              </motion.div>
            </motion.div>
